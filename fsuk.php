...
<ul class="nav nav-tabs color">
  ...
  <li class="nav-item dropdown">
    ...
    <div class="dropdown-menu">
      <a class="dropdown-item active" href="fsuk.php">Performance in FSUK 2017</a>
...
<div class="card-group">
  <div class="card text-center padd">
    ...
    <div class="card-body">
      <h5 class="card-title">BEST ASIAN TEAM AT <br> FSUK 2017 <br><img src = "trophy.png" class = "image"><br>OVERALL<br> 33RD</h5>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">STATIC EVENTS</h5>
      <p class="card-text">
      <ul class="list-group list-group-flush">
      <li class="list-group-item">Bussiness Presentation - 28th</li>
      <li class="list-group-item">Design Events - 17th</li>
      <li class="list-group-item">Cost Event - 59th</li>
     </ul>
      </p>
  ...
  <div class="card">
    <div class="card-body">
      <h5 class="card-title">DYNAMIC EVENTS</h5>
      <p class="card-text">
      <ul class="list-group list-group-flush">
      <li class="list-group-item">Acceleration - 22nd</li>
      <li class="list-group-item">Skipad - N/A</li>
      <li class="list-group-item">Autocross - 21st</li>
      <li class="list-group-item">Endurance - DNF</li>
     </ul>
      </p>
...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="fsuk/FSUK (1).jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="fsuk/FSUK (2).JPG" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="fsuk/FSUK (3).JPG" alt="Third slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="fsuk/FSUK (4).jpg" alt="fourth slide">
    </div>
  </div>
