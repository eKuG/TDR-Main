...
<img src="imgSponsors.png" class="img-fluid" alt="OurSponsors">
<div class="card mb-3 text-center">
  <div class="card-body">
    <h5 class="card-title">SPONSORSHIP DELIVERABLES</h5>
    <p class="card-text txt">We invite you to come onboard as our sponsor. With your help and support we can turn our mission a reality.</p>
